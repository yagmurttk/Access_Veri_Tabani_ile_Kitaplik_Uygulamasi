...
namespace Kitaplik_Proje
{
    public partial class Kitaplik : Form
    {
        ...
        OleDbConnection baglanti = new OleDbConnection(@"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\\Users\\ACER\\Desktop\\Kitaplik.mdb");
        ...
        private void BtnSil_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Close();
            MessageBox.Show("Kitap Listeden Silinmiştir.", "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            Listele();
        }
